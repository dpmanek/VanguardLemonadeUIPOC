...
const InsuranceChat = class {
    ...
    render() {
        return (h("div", { key: 'd95bc0180945b6c1759ed52d0ebc4d92a091f7f2', class: "app-wrapper" }, h("div", { key: 'da3c4b1422b9b696a25dd29bb3faa540a9ea00df', class: "container" }, h("app-navbar", { key: '6f21a4ef30d921f291014f4b8b0f87747687839f' }), h("div", { key: '3e695d1cc3f197af2edf7a8f1c2a6b67e7547bdd', class: "chat-interface", ref: el => (this.chatInterface = el) }, this.renderCurrentQuestion(), this.renderPreviousAnswers()), this.renderEditModal())));
    }
